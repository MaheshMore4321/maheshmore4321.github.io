...
class Sidebar extends Component {
	render() {
    	return (
    		<>
      			<aside id="sym-aside" className="border js-fullheight" style={{backgroundImage:`url(${this.props.data && this.props.data.background_picture_link})`, backgroundSize: 'cover', height:"-webkitFillAvailable"}}>
