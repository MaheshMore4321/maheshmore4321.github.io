    ...
    modal.push(
      <div className="modal" style={this.state.toggle ? display : hide}>
        <div className="modal-footer">
          <a className="form-control" onClick={this.toggle}>
            Close Modal
          </a>
        </div>
    ...
    return (
      <form onSubmit={this.handleSubmit}>
        ...
        <div className="row">
          ...
          <div  className="col-md-4">
            <a className="form-control" onClick={this.toggle}>
              {this.state.toggle ? "Close modal " : "Open modal "}Live Preview
            </a>
            {modal}
            {/*<Link target="_blank" className="form-control" to={"/view"}>
              {return (
                render() {
                  <PortfolioUi data={this.state.allData} />
                }
        ...
        <Router>
          <>
            <Switch>
              <Route
                exact path='/view'
                render={() => (<PortfolioUi data={this.state.allData}/>)}
              />
            </Switch>
          </>
        </Router>
