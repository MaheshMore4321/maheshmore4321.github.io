        ...
        <>
            <article className="timeline-entry animate-box fadeInLeft animated" data-animate-effect="fadeInLeft">
                <div className="timeline-entry-inner">
                    <div className={this.props.data.prj_icon}>
                        ...
                        <div className="panel panel-default">
                            <div className="panel-heading" role="tab" id="headingOne" style={{border:'none'}}>
                                <h4 className="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href={"#"+this.props.data.id} aria-expanded="false" aria-controls="collapseOne" className="collapsed">
                                        <p style={{margin:'0'}}>{parse(this.props.data.prj_nm)}</p>
                                        <p style={{margin:'0'}}>{parse(this.props.data.prj_org)}</p>
                                        <p style={{margin:'0'}}>{parse(this.props.data.prj_clnt)}</p>
                                        <p style={{margin:'0'}}>{parse(this.props.data.prj_dur)}</p>    
                                    </a>
                                </h4>
                            </div>
                            <div id={this.props.data.id} className="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne" aria-expanded="false" style={{height:'0px'}}>
                                <div className="panel-body">
                                    <div className="row">
                                        <p style={{lineheight:'1.4',margin:'0'}}>{parse(this.props.data.prj_tec)}</p>
                                        <p style={{lineheight:'1.4',margin:'0'}}>{parse(this.props.data.prj_typ)}</p>
                                        <p style={{lineheight:'1.4',margin:'0'}}>{parse(this.props.data.prj_env)}</p>  
                                        <p style={{lineheight:'1.4',margin:'0'}}>{parse(this.props.data.prj_role)}</p>
                                        <p style={{lineheight:'1.4',margin:'0'}}>{parse(this.props.data.prj_tmsz)}</p>
                                        <br/>  
